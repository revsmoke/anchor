...
| File | Purpose |
|------|---------|
| `/Users/twoedge/Dev/dbt/PLAN.md` | Pass 2 execution checklist |
| `/Users/twoedge/Dev/dbt/server/dates.js` | Shared date and timezone validation/resolution helper |
| `/Users/twoedge/Dev/dbt/server/app.js` | Resolves daily date options per authenticated daily route |
| `/Users/twoedge/Dev/dbt/server/db.js` | Uses supplied `localDate` for daily routine, plan, and focus-plan queries/writes |
| `/Users/twoedge/Dev/dbt/tests/unit/date-contract.test.js` | Timezone, explicit-date, and DST unit coverage |
| `/Users/twoedge/Dev/dbt/tests/api/pass2-timezone-contract.test.js` | Route contract and SQL-backed daily persistence tests |
| `/Users/twoedge/Dev/dbt/review/agent-pass2-timezone-PLAN.md` | Agent pre-task verification plan |
| `/Users/twoedge/Dev/dbt/review/agent-pass2-timezone-report.md` | Agent pre-task verification report |
| `/Users/twoedge/Dev/dbt/CAPABILITY_LEDGER.md` | Pass 2 capability and evidence record |
| `/Users/twoedge/Dev/dbt/context_history/context_index.md` | Indexed this session summary |
| `/Users/twoedge/Dev/dbt/context_history/contexts/2026-05-12_anchor-pass2-date-timezone-contract.md` | Session summary and handoff |
...
- `/Users/twoedge/Dev/dbt/server/dates.js`
- `/Users/twoedge/Dev/dbt/tests/api/pass2-timezone-contract.test.js`
